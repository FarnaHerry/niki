// The palette panel: one card per catalog component, grouped by category.
// Clicking a card appends that component to the document root.
...
inline void AddComponent(const editor::Editor& ed, const std::string& type) {
...
[[nodiscard]] inline View Card(const editor::Editor& ed, const catalog::ComponentDef& component) {
...
[[nodiscard]] inline View PaletteView(const editor::Editor& ed) {
